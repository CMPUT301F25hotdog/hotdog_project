...
public class EventCreationControllerTests {
    ...
    void setup() {
        ...
        controller = new EventCreationController(context, fakeRepo) {
            @Override
            public void SaveEvent(String name, String description, Date dateTime, Date openPeriod, Date closePeriod, int entrantLimit, int waitListSize, String location, double price, boolean requireGeo, String bannerUrl, ArrayList<String> tagList,String organizerName) {
    ...
    void tesSaveEvent() {
        ...
        controller.SaveEvent("Test Event", "Desc", new Date(), new Date(), new Date(), 10, 5, "Location", 20.0, true, "banner",empty,"Daniel");
